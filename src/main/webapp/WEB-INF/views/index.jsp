...
>
  ...
  <body>
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Vote and Voice에 오신 것을 환영합니다 🎉</h5>
                          <p class="mb-4">
                            Vote and voice는 편리한 정책 참여와 정보 제공을 위한 사이트입니다!
                          </p>
    ...
    <div class="buy-now">
      <a
        href="https://www.moleg.go.kr/menu.es?mid=a10105020000"
        target="_blank"
