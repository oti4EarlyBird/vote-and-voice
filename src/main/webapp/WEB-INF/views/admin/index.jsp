...
<body>
				...
				<div class="col-lg-8 mb-4 order-0">
					<div class="card">
						<div class="d-flex align-items-end row">
							<div class="col-sm-7">
								<div class="card-body">
									<h5 class="card-title text-primary">Vote and Voice에 오신 것을
										환영합니다 🎉</h5>
	...
	<div class="buy-now">
		<a href="https://www.moleg.go.kr/menu.es?mid=a10105020000"
			target="_blank" class="btn btn-danger btn-buy-now">국회
			법안이란?</a>
	</div>
